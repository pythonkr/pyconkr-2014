...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Program.is_recordable'
        db.add_column(u'pyconkr_program', 'is_recordable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Program.is_recordable'
        db.delete_column(u'pyconkr_program', 'is_recordable')
