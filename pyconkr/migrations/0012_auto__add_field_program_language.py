...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Program.language'
        db.add_column(u'pyconkr_program', 'language',
                      self.gf('django.db.models.fields.CharField')(default='ko', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Program.language'
        db.delete_column(u'pyconkr_program', 'language')
