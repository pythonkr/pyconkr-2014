...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'pyconkr_sponsor', 'level',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pyconkr.SponsorLevel'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sponsor.level'
        db.delete_column(u'pyconkr_sponsor', 'level_id')
