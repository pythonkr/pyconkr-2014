...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SponsorLevel.order'
        db.add_column(u'pyconkr_sponsorlevel', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SponsorLevel.order'
        db.delete_column(u'pyconkr_sponsorlevel', 'order')
